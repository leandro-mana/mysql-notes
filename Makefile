...
# Default target
help:
	@echo "MySQL Notes - Makefile Commands"
	@echo ""
	@echo "Docker:"
	@echo "  make up                  Start MySQL container"
	@echo "  make down                Stop MySQL container and remove volumes"
	@echo "  make reset               Rebuild MySQL container from scratch"
	@echo ""
	@echo "Setup:"
...
up:
	...
	@echo "  User: root | Password: root_password | Database: mysql_notes"

down:
	@echo "Stopping MySQL container..."
	docker compose down -v
	@echo "MySQL container stopped and volumes removed"

reset: down up
	@echo "MySQL container rebuilt from scratch"
