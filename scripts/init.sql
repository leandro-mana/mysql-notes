-- Initialize the mysql_notes database with sample data
...
('page_view', '2024-01-15 10:30:00', 1, '/api/books', 200, 45, '{"browser": "Chrome", "os": "macOS"}'),
('page_view', '2024-01-15 10:31:00', 1, '/api/books/1', 200, 32, '{"browser": "Chrome", "os": "macOS"}'),
('api_call', '2024-01-15 10:32:00', 2, '/api/orders', 201, 120, '{"method": "POST", "items": 2}'),
('error', '2024-01-15 10:33:00', 3, '/api/checkout', 500, 5000, '{"error": "timeout", "retry": true}'),
('page_view', '2024-01-15 11:00:00', 2, '/api/categories', 200, 28, '{"browser": "Firefox", "os": "Linux"}'),
('api_call', '2024-01-15 11:05:00', 1, '/api/orders', 201, 95, '{"method": "POST", "items": 1}'),
('page_view', '2024-01-16 09:00:00', 4, '/api/books', 200, 50, '{"browser": "Safari", "os": "iOS"}'),
('error', '2024-01-16 09:01:00', 4, '/api/books/999', 404, 15, '{"error": "not_found"}'),
('api_call', '2024-01-16 14:30:00', 5, '/api/orders', 201, 88, '{"method": "POST", "items": 3}'),
('page_view', '2024-01-17 08:00:00', 1, '/api/books', 200, 42, '{"browser": "Chrome", "os": "macOS"}');
